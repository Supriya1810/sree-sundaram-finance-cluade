...
export default function LoanCalculator() {
  ...
  return (
    <div id="loan-calculator-section" className="relative p-8 rounded-3xl bg-neutral-900/60 border border-amber-500/10 backdrop-blur-xl shadow-2xl overflow-hidden">
      {/* Visual background atmospheric glaze */}
      <div className="absolute top-0 right-0 w-32 h-32 bg-amber-500/5 rounded-full blur-3xl pointer-events-none" />
      <div className="absolute -bottom-10 -left-10 w-40 h-40 bg-amber-600/5 rounded-full blur-3xl pointer-events-none" />

      <div className="relative grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        {/* Controls Panel */}
        <div className="lg:col-span-7 space-y-6">
          <div>
            <span className="text-xs uppercase tracking-widest text-[#D4AF37] font-mono block mb-1">Interactive Tools</span>
            <h3 className="text-2xl font-serif font-semibold text-white">Gold Loan Evaluator</h3>
            <p className="text-sm text-neutral-400 mt-1">Estimate your collateral value and customized interest terms instantly.</p>
          </div>

          {/* Slider for Gold Weight */}
          <div className="space-y-2">
            <div className="flex justify-between items-center">
              <label htmlFor="gold-weight-slider" className="text-xs uppercase font-mono tracking-wider text-neutral-300 flex items-center gap-2">
                <Scale className="w-4 h-4 text-[#D4AF37]" /> Gold Ornaments Weight
              </label>
              <span className="text-lg font-mono font-medium text-[#D4AF37]">{weight} g</span>
            </div>
            <input
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {/* Purity selector */}
            <div className="space-y-2">
              <label htmlFor="gold-purity-select" className="text-xs uppercase font-mono tracking-wider text-neutral-300 flex items-center gap-2">
                <Milestone className="w-4 h-4 text-[#D4AF37]" /> Gold Purity
              </label>
            ...
            <div className="space-y-2">
              <label htmlFor="repayment-type-select" className="text-xs uppercase font-mono tracking-wider text-neutral-300 flex items-center gap-2">
                <Percent className="w-4 h-4 text-[#D4AF37]" /> Repayment Mode
              </label>
          ...
          <div className="space-y-2">
            <div className="flex justify-between items-center flex-wrap gap-2">
              <label htmlFor="tenure-duration-slider" className="text-xs uppercase font-mono tracking-wider text-neutral-300">
          ...
          <div className="p-3.5 rounded-xl bg-orange-500/5 border border-amber-500/10 flex items-start gap-3">
            <ShieldCheck className="w-5 h-5 text-[#D4AF37] shrink-0 mt-0.5" />
            <p className="text-[11px] text-neutral-400 leading-relaxed">
              <strong className="text-neutral-200 block mb-0.5">Note on Valuation Process</strong>
        ...
        {/* Results Screen */}
        <div id="evaluator-results" className="lg:col-span-5 p-6 rounded-2xl bg-black/40 border border-neutral-800/80 flex flex-col justify-between h-full space-y-6">
          <div className="space-y-5">
            <div className="border-b border-neutral-800 pb-4">
              <span className="text-[10px] font-mono tracking-widest text-[#D4AF37] uppercase">Maximum Loan Eligibility</span>
              ...
              <div className="flex justify-between items-center mt-2 text-xs text-neutral-400">
                ...
                <span className="font-mono text-neutral-200">{formattedValue(calculations.goldValue)}</span>
              </div>
            </div>
            ...
            <div className="space-y-3.5">
              <div className="flex justify-between text-xs">
                <span className="text-neutral-400 flex items-center gap-1.5">
                  <span className="w-1.5 h-1.5 rounded-full bg-[#D4AF37]" /> Interest Rate
                </span>
                <span className="font-semibold text-[#D4AF37] font-mono">{calculations.interestRate}% P.A.</span>
              </div>
              ...
              <div className="flex justify-between text-xs">
                ...
                <span className="font-semibold text-neutral-300 font-mono">{tenure} Months</span>
              </div>
              ...
              <div className="flex justify-between text-xs">
                ...
                <span className="font-semibold text-amber-500/95 font-mono">{formattedValue(calculations.totalInterestPayable)}</span>
              </div>
            </div>

            <div className="mt-4 p-3 rounded-xl bg-neutral-900/40 border border-neutral-800 space-y-1">
          ...
          <div className="space-y-2">
            <div className="flex items-center gap-1 text-[10px] text-emerald-400 font-mono bg-emerald-950/20 px-2 py-1 rounded w-fit">
